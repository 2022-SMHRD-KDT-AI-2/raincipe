...
@WebServlet("/myrecipeUpdateForm.do")
public class myrecipeUpdateFormController extends HttpServlet {
	...
	my_recipeVO vo = dao.getMy_recipe_seq(my_recipe_seq);	
     ...
     RequestDispatcher rd=request.getRequestDispatcher("recipe/myrecipeUpdate.jsp");
